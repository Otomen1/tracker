...
export function CategoryCard({ category, existingNames, hasTransactions, onUpdate, onDelete }: Props) {
  ...
  return (
    <>
      <div className="group flex items-center justify-between px-4 py-3 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hover:border-zinc-300 dark:hover:border-zinc-700 transition-colors">
